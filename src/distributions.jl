...
TODO
 1. revise pdf and logpdf of Dirichlet, they are in fact expectations at the moment
 2. add check_args to inputs
=#
...
immutable Gaussian1D <: Distribution
    ...
    Gaussian1D(mu::Float64, vv::Float64) = new(mu, vv)
end
...
# displaying the Gaussian1D distribution
...
# displaying the Dirichlet distribution
